...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.packname = '© VINN™'
        global.author = '© VINN™ 2022'
        global.packname2 = 'Made With'
        global.author2 = '© VINN™ 2022'
        global.wm3 = '·͟͟͟͟͟͟͞͞͞͞͞͞Made By VINN™˚'
        global.wm2 = '© Vinn BOT' + ' ' + 'VINN™'
        global.wm = '© VINN™'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'By Vinn BOT & VINN™'
        global.kontak2 = [
        ['6281257170601', 'VINN™', 'Creator Bot', 'Zivsan@support.com', true],
        ['6285828748603', 'Vinn BOT', 'Bot WhatsApp', 'Just Bot', true]
        ]
